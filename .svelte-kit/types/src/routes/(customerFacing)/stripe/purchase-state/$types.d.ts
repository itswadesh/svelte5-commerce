...
type RouteParams = {  };
type RouteId = '/(customerFacing)/stripe/purchase-state';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(customerFacing)/stripe/purchase-state/+page.server.js').load>>>>>>;
