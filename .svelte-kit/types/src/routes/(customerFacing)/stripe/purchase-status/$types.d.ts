...
type RouteParams = {  };
type RouteId = '/(customerFacing)/stripe/purchase-status';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(customerFacing)/stripe/purchase-status/+page.server.js').load>>>>>>;
