...
type RouteParams = {  };
type RouteId = '/(customerFacing)/products';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/(customerFacing)/products/+page.server.js').load>>>>>>;
