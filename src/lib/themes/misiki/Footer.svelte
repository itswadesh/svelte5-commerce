...
<footer class="w-full border-t border-surface-100 bg-[#fafafa]">
	<div class="justify-between p-3 lg:p-10">
		<div class=" w-full">
			{#if menu?.length}
				<ul
									...
									<li class="max-w-max">
										<a
											...
											<svg
												...
												class="h-6 w-6 transition duration-300 hover:text-[#4267B2]"
												viewBox="0 0 24 24"
												stroke-width="2"
												stroke="#333333"
												fill="none"
								...
								{#if $page.data.store?.socialSharingButtons?.instagram?.val}
									<li class="max-w-max">
										<a
											...
											<svg
												xmlns="http://www.w3.org/2000/svg"
												class="h-6 w-6 transition duration-300 hover:text-[#C13584]"
												viewBox="0 0 24 24"
												stroke-width="2"
												stroke="#333333"
												fill="none"
								...
								{#if $page.data.store?.socialSharingButtons?.twitter?.val}
									<li class="max-w-max">
										<a
											...
											<svg
												xmlns="http://www.w3.org/2000/svg"
												class="h-6 w-6 transition duration-300 hover:text-[#1DA1F2]"
												viewBox="0 0 24 24"
												stroke-width="2"
												stroke="#333333"
												fill="none"
								...
								{#if $page.data.store?.email}
									<li class="max-w-max">
										<a
											...
											<svg
												xmlns="http://www.w3.org/2000/svg"
												class="h-6 w-6 transition duration-300 hover:text-[#c71610]"
												viewBox="0 0 24 24"
												stroke-width="2"
												stroke="#333333"
												fill="none"
								...
								{#if $page.data.store?.socialSharingButtons?.linkedin?.val}
									<li class="max-w-max">
										<a
											...
											<svg
												xmlns="http://www.w3.org/2000/svg"
												class="h-6 w-6 transition duration-300 hover:text-[#0077b5]"
												viewBox="0 0 24 24"
												stroke-width="2"
												stroke="#333333"
												fill="none"
								...
								{#if $page.data.store?.socialSharingButtons?.youtube?.val}
									<li class="max-w-max">
										<a
											...
											<svg
												xmlns="http://www.w3.org/2000/svg"
												class="h-6 w-6 transition duration-300 hover:text-[#c8232c]"
												viewBox="0 0 24 24"
												stroke-width="2"
												stroke="#333333"
												fill="none"
								...
								<li class="col-span-1">
									{#if item.link}
										<a
											...
											class="block">
											<h6 class="mb-4 whitespace-nowrap text-lg font-normal">
												{item.name}
											</h6>
										</a>
									{:else}
										<h6
											class="mb-4 whitespace-nowrap text-surface-500 text-xl font-black uppercase">
											{item.name}
										</h6>
									{/if}
												...
												<li class="flex max-w-max items-center">
													{#if item2.link}
														<a
															...
															target="_blank"
															aria-label="Click to visit this page"
															class="text-surface-500 hover:text-black transition duration-300 capitalize whitespace-pre-wrap">
															{item2.name}
														</a>
													{:else}
														<span
															class="text-surface-500 transition duration-300 capitalize whitespace-pre-wrap">
															{item2.name}
														</span>
													{/if}
												</li>
											...
											{#if mx === 0}
												<li class="flex max-w-xs items-center">
													<form
														...
														<PrimaryButton
															roundedNone
															class="w-full text-xs bg-surface-500 hover:bg-[#000000]">
															Sign Up
														</PrimaryButton>
													</form>
												</li>
	...
	<div class="mx-10 py-10 border-t border-surface-light">
