					...
					{#if i <= 6}
						{#if category.img}
							<a
								...
								<h6
									class="w-full overflow-ellipsis text-center capitalize text-zinc-500 line-clamp-2 group-hover:text-primary-500">
									{category.name}
								</h6>
							</a>
						{:else}
						...
						{#if i < 12}
							{#if category.img}
								<a
									...
									<h6
										class="w-full overflow-ellipsis text-center capitalize text-zinc-500 line-clamp-2">
										{category.name}
									</h6>
								</a>
							{:else}
